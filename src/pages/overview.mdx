...
The API is organised around websockets and a JSON message interface which is based on and guided by the open, industry standard [documentation](https://www.nexo-standards.org/) V3.1.
