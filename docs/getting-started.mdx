...
Property | QR | Format |
---------| ------ | ----------- |
[SaleID](/docs/api-reference/data-model#saleid) | s | String. UUID v4. Uppercase. |
| | | 8-4-4-4-12 format. | 
PairingPOIID | p | String. UUID v4. Uppercase. |
[KEK](/docs/api-reference/data-model#kek) | k | String. |
| | | 24 random characters from 0-9 and A-F |
...
| | Demo Application implementing the Pairing NuGetPackage | on [GitHub] (https://github.com/datameshgroup/sdk-dotnet-testpos) |
