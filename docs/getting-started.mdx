...
Once you have installed the Fusion App in your local Windows PC, you should be able to access its Swagger API documentation at <a href="http://localhost:4242/swagger">`http://localhost:4242/swagger`</a> in the same PC.
