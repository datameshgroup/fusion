...
The Fusion App is a DataMesh middleware that is installed in the same Winodws PC where the Sale System application is running on.  

The Fusion App uses the [Fusion Cloud API](./APIs/cloud-api-reference).  It communicates with the POI terminal via a Websocket connected to the DataMesh Unify switch.  

The Sale System sends a payment request and receives a payment result through the Fusion App's local HTTP end point for payments.  
...
The Fusion App is a DataMesh middleware that is installed in the same Windows PC where the Sale System application is running on. 

The Fusion App uses the [Fusion Cloud API](./APIs/cloud-api-reference).  It communicates with the POI terminal via a Websocket connected to the DataMesh Unify switch. 

Requests and responses are sent and received through the Fusion App's local HTTP end points.

*Contact the DataMesh Integrations team at <a href="mailto:integrations@datameshgroup.com">integrations@datameshgroup.com</a> if you need the latest Fusion App installer.*

:::info

Once you have installed the Fusion App in your local Windows PC, you should be able to access its Swagger API documentation at <a href="http://localhost:4242/swagger">`http://localhost:4242/swagger`</a> in your local PC.

:::

Below are *sample* http requests available in the Fusion App. 

To get the complete and updated Fusion App API details, please refer to the <a href="http://localhost:4242/swagger">Fusion App Swagger API documentation</a>, which is accessible *after you've installed the Fusion App* in your local PC.

<!-- Start of Fusion App Sample -->

##### *Fusion App* Payment Processing

Sends a payment request to the DataMesh Unify payments platform.

<details><summary><b>[POST]</b> /fusion/v1/payments/<i><b>SessionID</b></i></summary>
<p>

<Tabs>
  <TabItem value="parameters" label="Request" default>

```jsx title="Parameters"

SessionID - Unique identifier for this request, formatted as a UUIDv4
  ...
  "PaymentRequest": {
    "SaleData": {
      ...
      "SaleTransactionID": {
        ...
        "TimeStamp": "2023-02-24T02:43:02.236Z"
      },
      ...
      "SaleTerminalData": {
        ...
        "SaleProfile": {
          "GenericProfile": "Unknown"
        },
        "TotalsGroupID": "string"
      },
      "TokenRequestedType": "Unknown",
    ...
    "PaymentTransaction": {
      "AmountsReq": {
        ...
        "SurchargeAmount": 0,
        "PaidAmount": 0,
        "MinimumAmountDeliver": 0,
        "MaximumCashBackAmount": 0,
        "MinimumSplitAmount": 0
      },
      ...
      "PaymentInstrumentData": {
        ...
        "CardData": {
          ...
          "PaymentToken": {
            "TokenRequestedType": "Unknown",
            "TokenValue": "string",
            "ExpiryDateTime": "2023-02-24T02:43:02.236Z"
          }
        }
      }
    }
...
<details><summary>Status Code: <b>200</b></summary>
<p>
...
```jsx title="Response body (Example Value)"
{
    "PaymentResponse": {
        "Response": {
            "Result": "Success"
        ...
        "SaleData": {
            "SaleTransactionID": {
                "TransactionID": "f03ca0a2-044e-4782-b824-f8882b298863",
                "TimeStamp": "2023-02-24T12:31:20+11:00"
            }
        },
        "POIData": {
            "POITransactionID": {
                "TransactionID": "63f81369a138f54ffa8e4030",
                "TimeStamp": "2023-02-24T12:31:43.777+11:00"
            },
            "POIReconciliationID": "624fbb8bd8dd1a41e1c9caf9"
        },
        "PaymentResult": {
            "PaymentType": "Normal",
            "PaymentInstrumentData": {
                ...
                "CardData": {
                    "PaymentBrand": "VISA",
                    "Account": "Credit",
                    "MaskedPAN": "419957XXXXXX1234",
                    "EntryMode": "Tapped"
                }
            },
            "AmountsResp": {
                "Currency": "AUD",
                "AuthorizedAmount": 10.16,
                "TotalFeesAmount": 0,
                "CashBackAmount": 0,
                "TipAmount": 0,
                "SurchargeAmount": 0.16
            },
            "OnlineFlag": true,
            "PaymentAcquirerData": {
                "AcquirerID": "xxxxxx",
                "MerchantID": "xxxxxxxxx",
                "AcquirerPOIID": "xxxxxx",
                "AcquirerTransactionID": {
                    "TransactionID": "xxxxxxxxxxxxxxxxxxxxxxxx",
                    "TimeStamp": "2023-02-24T01:31:44.079Z"
                },
                "ApprovalCode": "xxxxxxx",
                "ResponseCode": "xx",
                "RRN": "xxx",
...
```jsx title="Status Code: 400"
	
Request format is invalid. Check body for failure reason

```

```jsx title="Status Code: 415"
		
ACCEPT header is not set to application/json

```

```jsx title="Status Code: 500"
	
Internal application error. Enter error recovery.
...
##### *Fusion App* Error Recovery

Enters error recovery for a previous payment where the POS didn't receive a payment response

<details><summary><b>[GET]</b> /fusion/v1/payments/<i><b>SessionID</b></i></summary>
<p>
...
If a payment response could be returned. Check Response.Result for financial payment result.
...
```jsx title="Response body (Example Value)"
{
  "PaymentResponse": {
    ...
    "SaleData": {
      ...
      "SaleTransactionID": {
        "TransactionID": "string",
        "TimeStamp": "2023-02-24T04:00:27.284Z"
      },
      "SaleReferenceID": "string",
      "SaleTerminalData": {
        "TerminalEnvironment": "Unknown",
      ...
      "PaymentInstrumentData": {
        ...
        "CardData": {
          ...
          "PaymentToken": {
            "TokenRequestedType": "Unknown",
            "TokenValue": "string",
            "ExpiryDateTime": "2023-02-24T04:00:27.284Z"
          }
        }
      },
      "AmountsResp": {
        "Currency": "Unknown",
        "AuthorizedAmount": 0,
        "TotalRebatesAmount": 0,
        "TotalFeesAmount": 0,
        "CashBackAmount": 0,
        "TipAmount": 0,
        "SurchargeAmount": 0,
        "RequestedAmount": 0,
        "PartialAuthorizedAmount": 0
      },
      "CurrencyConversion": {
