...
The Fusion App uses the [Fusion Cloud API](/docs/api-reference/fusion-cloud).  It communicates with the POI terminal via a Websocket connected to the DataMesh Unify switch.  
...
:::info
This section will make reference to methods and data structures documented in the <a href="/docs/api-reference/fusion-cloud">Cloud API Reference</a>. 
:::
...
See the [Fusion App API Reference](/docs/api-reference/fusion-app) for further details.

<!-- Start of Fusion App Sample 



!!!!!! TODO: CAN PROBABLY BRING SOME OF THIS INTO THE FUSION APP SECTION !!!!!!
...
- **[Fusion Satellite API](/docs/api-reference/satellite-api-reference)**
...
- ** [Fusion Cloud API](/docs/api-reference/fusion-cloud)**
...
1. Sale system constructs a [payment request](/docs/api-reference/fusion-cloud#paymentrequest) object.
1. Sale System sends the [payment request](/docs/api-reference/fusion-cloud#paymentrequest) for the *payment-id* to the Fusion App's local HTTP end point for payments and waits for a response.
...
- Build a standard [payment request](/docs/api-reference/satellite-api-reference#payment)
